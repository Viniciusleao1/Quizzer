...
<a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Entrar</b></span></a></div>
<!--sign in modal start-->
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Digite seu nome" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="gender" name="gender" placeholder="Digite seu gênero" class="form-control input-md" >
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Digite o nome da sua escola" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Digite seu número de celular" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="Registrar" class="btn btn-primary"/>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://github.com/Viniciusleao1" style="color:#202020; font-family:'typo' ; font-size:18px" title="Meu GitHub">Viniciusleao1</a>
...
<div class="form-group">
<input type="text" name="uname" maxlength="20"  placeholder="Usuário Admin" class="form-control"/> 
</div>
<div class="form-group">
