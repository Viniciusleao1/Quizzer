...
<div class="col-lg-6">
<span class="logo">Quiz de Perguntas || Viniciusleao1</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
if ((!isset($_SESSION['username']))) {
    ...
    echo '<a href="logout.php?q=feedback.php" class="pull-right logb btn btn-primary"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Sair</font></a>&nbsp;';
}
?>

<a href="index.php" class="pull-right logb btn btn-primary"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Inicio</font></a>&nbsp;
</div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:darkblue;font-weight:bold">Faça login na sua conta</span></h4>
      </div>
...
<h2 align="center" style="font-family:'typo'; color:#000066">Sobre o Quiz de Perguntas</h2>
...
while (!feof($file)) {
    ...
    for ($i = 0; $i < $num; $i++) {
      if ($i > 0) {
        ...
        // Defina um valor padrão para $last caso $i seja 0 ou negativo
        $last = null; // ou algum outro valor que faça sentido no seu contexto
    }
...
<div class="col-md-2 box">
<span href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">Sobre</span></div>
</div>
</body>
</html>
